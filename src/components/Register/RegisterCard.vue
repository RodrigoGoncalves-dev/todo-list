                ...
                <div class="grid gap-2">
                        ...
                        <div class="w-1/2 mr-4">
                            ...
                            >
                                <input
                                    ...
                                    class="bg-gray-800 w-44 row-start-1 h-11 p-5 text-gray-50 text-lg placeholder-gray-400 font-light border border-gray-800 rounded-sm focus:outline-none"
                    ...
                    >
                        <input
                            ...
                            class="bg-gray-800 w-96 h-11 p-5 text-lg text-gray-50 placeholder-gray-400 font-light border border-gray-800 rounded-sm focus:outline-none"
